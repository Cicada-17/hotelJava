		...
		<div class="container-fluid">		
	        ...
	        <ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown visible-md visible-lg">
	        		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img class="user-avatar" src="assets/img/avatar.jpg" alt="user-mail">${sysuser.username}</a>
	...
	<div class="container-fluid content">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							...
							<c:if test="${sysuser.power=='1'}"><li>
								<a href="employees.jsp"><i class="fa  fa-list-alt"></i><span class="text"> 工资查询</span> </a>
								
							</li>
							
							</c:if>
							<c:if test="${sysuser.power=='2'}"><li>
								<a href="manager1.jsp"><i class="fa  fa-group "></i><span class="text"> 员工管理</span> </a>
								
							</li>
							<li><a href="manager2.jsp"><i class="fa  fa-search"></i><span class="text"> 工资查询</span></a></li></c:if>
						<c:if test="${sysuser.power=='3'}">	<li>
								...
								<ul class="nav sub">
									<li><a href="money1.jsp"><i class="fa  fa-gear"></i><span class="text"> 工资项目管理</span></a></li>
									<li><a href="money2.jsp"><i class="fa  fa-star"></i><span class="text"> 固定工资管理</span></a></li>
									<li><a href="money3.jsp"><i class="fa  fa-folder-open"></i><span class="text">导入项目数据录入</span></a></li>
								</ul>
							</li>
							<li>
		...
		<div class="main">
			...
			<div class="row">
				...
				</div><h3 class="page-header"><i class="fa fa-list-alt"></i> 工资查询</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.jsp">首页</a></li>
						<li><i class="fa fa-list-alt"></i>工资查询</li>						  	
					</ol>
			</div>
...
<script type="text/javascript">
 function YYYYMMDDstart()   
   {   
	...
	function s(){
		var id = "${sysuser.username}";
		
		 $.ajax({
                    type:"post",
                    url:"<%=basePath%>yuangong",  //需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
                    data:{//设置数据源
                    ...
                    success:function(data){
                       ...
                       asd+=msg.chidaokou;
                       asd+="</td><td>";
                       asd+=msg.gerenyanglao;
                       asd+="</td><td>";
                       asd+=msg.gongsiyanglao;
                       asd+="</td><td>";
                       asd+=msg.gerengongjijin;
                       asd+="</td><td>";
                       asd+=msg.gerenshui;
                       asd+="</td></tr>";
...
<script language="JavaScript"><!--   
		...
		<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-list-alt red"></i><span class="break"></span><strong>工资明细<form name="reg_testdate" action="" method="post"> 
  ...
  <input type="button" value="提交" onclick="s()" class="btn btn-info"/>
